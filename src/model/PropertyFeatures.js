...
function PropertyFeatures(data, id) {
  ...
  this.air_conditioning = data.airCondtioner || 0;
  this.pool = data.pool || 0;
  this.balcony = data.balcony || 0;
  this.barbecue_grill = data.barbecueGrill || 0;
  this.stairway = data.stairway || 0;
  this.garden = data.garden || 0;
  this.property_id = id || 0;
  this.fire_security = data.fireSecurity || 0;
  this.camera_security = data.cameraSecurity || 0;
